module github.com/malytinKonstantin/go-messenger-mono/notification-service
...
require (
	...
	github.com/malytinKonstantin/go-messenger-mono/shared v0.0.0-00010101000000-000000000000
)
